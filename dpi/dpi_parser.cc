...
int dpi_parser_2_app[DPI_PARSER_MAX] = {
        ...
        dpi_parser_2_app[DPI_PARSER_SSL]   =     DPI_APP_SSL,
        dpi_parser_2_app[DPI_PARSER_SSH]   =     DPI_APP_SSH,
        dpi_parser_2_app[DPI_PARSER_DNS]    =    DPI_APP_DNS,
        dpi_parser_2_app[DPI_PARSER_DHCP]   =    DPI_APP_DHCP,
        dpi_parser_2_app[DPI_PARSER_NTP]    =    DPI_APP_NTP,
        dpi_parser_2_app[DPI_PARSER_TFTP]   =    DPI_APP_TFTP,
        dpi_parser_2_app[DPI_PARSER_ECHO]   =    DPI_APP_ECHO,
        dpi_parser_2_app[DPI_PARSER_MYSQL]  =    DPI_APP_MYSQL,
        dpi_parser_2_app[DPI_PARSER_REDIS]  =    DPI_APP_REDIS,
        dpi_parser_2_app[DPI_PARSER_ZOOKEEPER] = DPI_APP_ZOOKEEPER,
        dpi_parser_2_app[DPI_PARSER_CASSANDRA] = DPI_APP_CASSANDRA,
        dpi_parser_2_app[DPI_PARSER_MONGODB]  =  DPI_APP_MONGODB,
        dpi_parser_2_app[DPI_PARSER_POSTGRESQL] = DPI_APP_POSTGRESQL,
        dpi_parser_2_app[DPI_PARSER_KAFKA]   =   DPI_APP_KAFKA,
        dpi_parser_2_app[DPI_PARSER_COUCHBASE] = DPI_APP_COUCHBASE,
        dpi_parser_2_app[DPI_PARSER_SPARK]  =    DPI_APP_SPARK,
        dpi_parser_2_app[DPI_PARSER_TNS]   =     DPI_APP_TNS,
        dpi_parser_2_app[DPI_PARSER_TDS]   =     DPI_APP_TDS,
        dpi_parser_2_app[DPI_PARSER_GRPC]   =    DPI_APP_GRPC,
};
