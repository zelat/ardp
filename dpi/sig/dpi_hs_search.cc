...
// ---------------------------------------------------------------------------------------------------------------------
//初始化
dpi_hs_search::dpi_hs_search(dpi_detector_t *dt, dpi_hs_search_t *hsSearch)
...
dpi_hs_search_t *dpi_hs_search::dpi_dlp_hs_search_create() {
...
void dpi_hs_search::dpi_dlp_hs_search_add_dlprule(dpi_sig_t *sig) {
    return;
}


void dpi_hs_search::dpi_dlp_hs_search_compile() {
