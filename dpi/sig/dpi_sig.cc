                    ...
                    const char *text, dpi_detector_t *detector)
{
    ...
    macro = (dpi_sig_macro_sig_t *)calloc(1, sizeof(dpi_sig_macro_sig_t));
    if (macro == NULL) {
    ...
    sig = (dpi_sig_t *)calloc(1, sizeof(dpi_sig_t));
    if (sig == NULL) {
        dpi_dlp_release_macro_rule(macro);
        return DPI_SIGOPT_FAILED;
    }
...
static dpi_sig_context_class_t ContextType2Class[DPI_SIG_CONTEXT_TYPE_MAX] = {
        ContextType2Class[DPI_SIG_CONTEXT_TYPE_URI_ORIGIN]    =      DPI_SIG_CONTEXT_CLASS_URI,
        ContextType2Class[DPI_SIG_CONTEXT_TYPE_HEADER]        =      DPI_SIG_CONTEXT_CLASS_HEADER,
        ContextType2Class[DPI_SIG_CONTEXT_TYPE_BODY]          =      DPI_SIG_CONTEXT_CLASS_BODY,
        ContextType2Class[DPI_SIG_CONTEXT_TYPE_SQL_QUERY]     =      DPI_SIG_CONTEXT_CLASS_BODY,
        ContextType2Class[DPI_SIG_CONTEXT_TYPE_PACKET_ORIGIN] =     DPI_SIG_CONTEXT_CLASS_PACKET,
};
...
static dpi_detector_t *dpi_dlp_detector_init(int apply_dir)
{
    ...
    detector = (dpi_detector_t *)calloc(sizeof(dpi_detector_t), 1);
    if (!detector) {
