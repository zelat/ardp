...
static void dpi_build_hs_mpse_tree (dpi_detector_t *detector)
{
    ...
    detect_tree = (dpi_sig_detect_tree_t *)calloc(1, sizeof(dpi_sig_detect_tree_t));
    if (detect_tree != NULL) {
...
dpi_sig_user_t *dpi_dlp_ep_match (dpi_packet_t *p, dpi_sig_t *sig){
    ...
    if (key.sigid >= DPI_SIG_MIN_WAF_SIG_ID) {
        ...
        io_dlp_cfg_t *waf_cfg = (io_dlp_cfg_t *)rcu_map_lookup(&ep->waf_cfg_map, &key);
        if (waf_cfg != NULL) {
        ...
        io_dlp_cfg_t *dlp_cfg = (io_dlp_cfg_t *)rcu_map_lookup(&ep->dlp_cfg_map, &key);
        if (dlp_cfg != NULL) {
...
static dpi_dlp_context_status_t base_app_dlp_context_status[] = {
        base_app_dlp_context_status[DPI_APP_HTTP - DPI_APP_BASE_START] = {1, 1, 1,},
        base_app_dlp_context_status[DPI_APP_SSL - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_SSH - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_DNS - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_DHCP - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_NTP - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_TFTP - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_ECHO - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_RTSP - DPI_APP_BASE_START] = {0, 0, 0,},
        base_app_dlp_context_status[DPI_APP_SIP - DPI_APP_BASE_START] = {0, 0, 0,},
};

static dpi_dlp_context_status_t app_dlp_context_status[] = {
        app_dlp_context_status[DPI_APP_MYSQL - DPI_APP_PROTO_MARK]  = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_REDIS - DPI_APP_PROTO_MARK]  = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_ZOOKEEPER - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_CASSANDRA - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_MONGODB - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_POSTGRESQL - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_KAFKA - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_COUCHBASE - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_WORDPRESS - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_ACTIVEMQ - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_COUCHDB - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_ELASTICSEARCH - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_MEMCACHED - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_RABBITMQ - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_RADIUS - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_VOLTDB - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_CONSUL - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_SYSLOG - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_ETCD - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_SPARK - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_APACHE - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_NGINX - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_JETTY - DPI_APP_PROTO_MARK] = {1, 1, 1,},
        app_dlp_context_status[DPI_APP_NODEJS - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_ERLANG_EPMD - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_TNS - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_TDS - DPI_APP_PROTO_MARK] = {0, 0, 0,},
        app_dlp_context_status[DPI_APP_GRPC - DPI_APP_PROTO_MARK] = {0, 0, 0,},
};
...
static void dpi_arrange_search_buffer (dpi_packet_t *p)
{
    ...
    for (t = DPI_SIG_CONTEXT_TYPE_URI_ORIGIN; t < DPI_SIG_CONTEXT_TYPE_MAX; t = (dpi_sig_context_type_t)(t + 1)) {
...
bool dpi_waf_ep_policy_check (dpi_packet_t *p) {
    ...
    if (!ep->dlp_inside) {
        io_dlp_ruleid_t *waf_rid = (io_dlp_ruleid_t *)rcu_map_lookup(&ep->waf_rid_map, &key);
...
bool dpi_dlp_ep_policy_check (dpi_packet_t *p) {
    ...
    if (!ep->dlp_inside) {
        io_dlp_ruleid_t *dlp_rid = (io_dlp_ruleid_t *)rcu_map_lookup(&ep->dlp_rid_map, &key);
        //only detect traffic that match network policy id for outside wl
        if (dlp_rid != NULL) {
