...
namespace dpi {
    ...
    static threat_property_t threat_property[] = {
            [(int)DPI_THRT_NONE] { 0, },
            [(int)DPI_THRT_TCP_FLOOD] { THRT_ID_SYN_FLOOD, THRT_SEVERITY_CRITICAL, 1, 1, 10, },
            [(int)DPI_THRT_ICMP_FLOOD] { THRT_ID_ICMP_FLOOD, THRT_SEVERITY_CRITICAL, 1, 1, 10, },
            [(int)DPI_THRT_IP_SRC_SESSION] { THRT_ID_IP_SRC_SESSION, THRT_SEVERITY_HIGH, 1, 1, 10, },
            [(int)DPI_THRT_BAD_PACKET] { THRT_ID_BAD_PACKET, THRT_SEVERITY_MEDIUM, 0, 0, 10, },
            [(int)DPI_THRT_IP_TEARDROP] { THRT_ID_IP_TEARDROP, THRT_SEVERITY_CRITICAL, 0, 1, 10, },
            [(int)DPI_THRT_TCP_SYN_DATA] { THRT_ID_TCP_SYN_DATA, THRT_SEVERITY_MEDIUM, 0, 0, 10, },
            [(int)DPI_THRT_TCP_SPLIT_HDSHK] { THRT_ID_TCP_SPLIT_HDSHK, THRT_SEVERITY_MEDIUM, 0, 0, 10, },
            [(int)DPI_THRT_TCP_NODATA] { THRT_ID_TCP_NODATA, THRT_SEVERITY_MEDIUM, 0, 1, 10, },
            [(int)DPI_THRT_TCP_SMALL_WINDOW] { THRT_ID_TCP_SMALL_WINDOW, THRT_SEVERITY_HIGH, 0, 1, 10, },
            [(int)DPI_THRT_TCP_SMALL_MSS] { THRT_ID_TCP_SMALL_MSS, THRT_SEVERITY_HIGH, 0, 0, 10, },
            [(int)DPI_THRT_PING_DEATH] { THRT_ID_PING_DEATH, THRT_SEVERITY_CRITICAL, 0, 0, (uint32_t) (-1), },
            [(int)DPI_THRT_DNS_LOOP_PTR] { THRT_ID_DNS_LOOP_PTR, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_SSH_VER_1] { THRT_ID_SSH_VER_1, THRT_SEVERITY_LOW, 0, 0, 10, },
            [(int)DPI_THRT_SSL_HEARTBLEED] { THRT_ID_SSL_HEARTBLEED, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_SSL_CIPHER_OVF] { THRT_ID_SSL_CIPHER_OVF, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_SSL_VER_2OR3] { THRT_ID_SSL_VER_2OR3, THRT_SEVERITY_MEDIUM, 0, 0, 10, },
            [(int)DPI_THRT_SSL_TLS_1DOT0] { THRT_ID_SSL_TLS_1DOT0, THRT_SEVERITY_INFO, 0, 0, 10, },
            [(int)DPI_THRT_HTTP_NEG_LEN] { THRT_ID_HTTP_NEG_LEN, THRT_SEVERITY_HIGH, 0, 0, 10, },
            [(int)DPI_THRT_HTTP_SMUGGLING] { THRT_ID_HTTP_SMUGGLING, THRT_SEVERITY_HIGH, 0, 0, 10, },
            [(int)DPI_THRT_HTTP_SLOWLORIS] { THRT_ID_HTTP_SLOWLORIS, THRT_SEVERITY_CRITICAL, 0, 1, 10, },
            [(int)DPI_THRT_DNS_OVERFLOW] { THRT_ID_DNS_OVERFLOW, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_MYSQL_ACCESS_DENY] { THRT_ID_MYSQL_ACCESS_DENY, THRT_SEVERITY_INFO, 0, 0, 10, },
            [(int)DPI_THRT_DNS_ZONE_TRANSFER] { THRT_ID_DNS_ZONE_TRANSFER, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_ICMP_TUNNELING] { THRT_ID_ICMP_TUNNELING, THRT_SEVERITY_CRITICAL, 0, 0, (uint32_t) (-1), },
            [(int)DPI_THRT_DNS_TYPE_NULL] { THRT_ID_DNS_TYPE_NULL, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_SQL_INJECTION] { THRT_ID_SQL_INJECTION, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_APACHE_STRUTS_RCE] { THRT_ID_APACHE_STRUTS_RCE, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
            [(int)DPI_THRT_K8S_EXTIP_MITM] { THRT_ID_K8S_EXTIP_MITM, THRT_SEVERITY_CRITICAL, 0, 0, 10, },
    };

    static threat_config_t threat_config[] = {
            [(int)DPI_THRT_NONE] { false, DPI_ACTION_NONE, },
            [(int)DPI_THRT_TCP_FLOOD] { false, DPI_ACTION_DROP, },
            [(int)DPI_THRT_ICMP_FLOOD] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_IP_SRC_SESSION] { false, DPI_ACTION_DROP, },
            [(int)DPI_THRT_BAD_PACKET] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_IP_TEARDROP] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_TCP_SYN_DATA] { false, DPI_ACTION_DROP, }, // Some load balancer has the behavior
            [(int)DPI_THRT_TCP_SPLIT_HDSHK] { true, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_TCP_NODATA] { false, DPI_ACTION_RESET, }, // FIXME: disabled because tap rx is prone to packet loss
            [(int)DPI_THRT_TCP_SMALL_WINDOW] { false, DPI_ACTION_RESET, },
            [(int)DPI_THRT_TCP_SMALL_MSS] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_PING_DEATH] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_DNS_LOOP_PTR] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_SSH_VER_1] { true, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_SSL_HEARTBLEED] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_SSL_CIPHER_OVF] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_SSL_VER_2OR3] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_SSL_TLS_1DOT0] { false, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_HTTP_NEG_LEN] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_HTTP_SMUGGLING] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_HTTP_SLOWLORIS] { false, DPI_ACTION_RESET, }, // FIXME: disabled because tap rx is prone to packet loss
            [(int)DPI_THRT_DNS_OVERFLOW] { true, DPI_ACTION_ALLOW, }, // FIXME: Make it drop
            [(int)DPI_THRT_MYSQL_ACCESS_DENY] { true, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_DNS_ZONE_TRANSFER] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_ICMP_TUNNELING] { true, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_DNS_TYPE_NULL] { false, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_SQL_INJECTION] { true, DPI_ACTION_ALLOW, },
            [(int)DPI_THRT_APACHE_STRUTS_RCE] { true, DPI_ACTION_DROP, },
            [(int)DPI_THRT_K8S_EXTIP_MITM] { true, DPI_ACTION_DROP, },
    };
