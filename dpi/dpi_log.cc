...
static threat_property_t threat_property[] = {
        ...
        threat_property[DPI_THRT_ICMP_TUNNELING] = {THRT_ID_ICMP_TUNNELING, THRT_SEVERITY_CRITICAL, 0, 0,
                                                    (uint32_t) (-1),},
...
static threat_config_t threat_config[] = {
        ...
        threat_config[DPI_THRT_TCP_NODATA] = {false,
                                              DPI_ACTION_RESET,}, // FIXME: disabled because tap rx is prone to packet loss
        ...
        threat_config[DPI_THRT_HTTP_SLOWLORIS] = {false,
                                                  DPI_ACTION_RESET,}, // FIXME: disabled because tap rx is prone to packet loss
